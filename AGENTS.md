...
Before pushing any commit or posting any external reply (PR comment, discussion comment, issue comment) that affects the public face of this repository, run **three adversarial reviewers in parallel** using whatever sub-agent / sub-task / spawn-agent capability the harness exposes:
