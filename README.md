...
[![Version](https://img.shields.io/badge/version-0.8.1-blue.svg)](https://github.com/LifelongLazyLearner/qu-ai-wei/releases)
...
> ⚠️ **0.x 开发版（当前 v0.8.1）:** qu-ai-wei 仍在迭代，规则、分类、API 都可能变动。欢迎提 [issue](https://github.com/LifelongLazyLearner/qu-ai-wei/issues) / [discussion](https://github.com/LifelongLazyLearner/qu-ai-wei/discussions) / PR 反馈。
>
...
当前 v0.8.1 的行为仍是「扫地机 + 打磨工」,但所有冲突统一按 `SKILL.md` 的「冲突仲裁顺序」六级处理:
...
| 方面 | 英文 humanizer | qu-ai-wei（当前 v0.8.1） |
|---|---|---|
